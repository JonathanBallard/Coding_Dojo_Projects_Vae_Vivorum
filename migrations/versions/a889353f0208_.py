...
Revision ID: a889353f0208
Revises: 
Create Date: 2020-03-10 17:00:37.050704
...
def upgrade():
    ...
    sa.Column('abilityPointsEarned', sa.Integer(), nullable=True),
    sa.Column('abilityPointsSpent', sa.Integer(), nullable=True),
